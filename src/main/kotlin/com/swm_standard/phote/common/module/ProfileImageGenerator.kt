...
class ProfileImageGenerator {
    ...
    val color: List<String> =
        listOf("b6e3f4", "c0aede", "d1d4f9", "ffd5dc", "ffdfbf", "cb9e6e", "eac393", "ffdbac", "f5cfa0")

    fun imageGenerator(): String =
        "https://api.dicebear.com/9.x/pixel-art-neutral/svg?" +
            "seed=${seed.random()}&eyes=${eyes.random()}&mouth=${mouth.random()}&backgroundColor=${color.random()}"
}
